...
const KEYWORDS =
  /\b(SELECT|FROM|WHERE|AND|OR|JOIN|LEFT|RIGHT|INNER|OUTER|ON|GROUP|BY|ORDER|LIMIT|OFFSET|TOP|FETCH|NEXT|ROWS|ONLY|AS|WITH|CASE|WHEN|THEN|ELSE|END|NOT|NULL|IS|IN|BETWEEN|DISTINCT|HAVING|ASC|DESC|UNION|ALL)\b/gi
