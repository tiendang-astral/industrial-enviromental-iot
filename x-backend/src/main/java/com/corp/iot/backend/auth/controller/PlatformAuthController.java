...
/**
 * Login/refresh/logout riêng cho x-frontend-admin (platform_user). Path
 * `/api/v1/platform/auth` khác hẳn TenantAuthController để cookie
...
public class PlatformAuthController {
    ...
    private static final String COOKIE_PATH = "/api/v1/platform/auth";
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> login(@Valid @RequestBody LoginRequest request) {
        LoginResult result = authService.loginPlatform(request.username(), request.password());
