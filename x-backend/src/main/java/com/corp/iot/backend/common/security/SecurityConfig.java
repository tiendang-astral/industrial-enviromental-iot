    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // WebSocket handshake HTTP GET không mang được Authorization header (browser
                        // WebSocket API không cho set header tuỳ ý) — auth thật xảy ra ở STOMP CONNECT
                        // frame (StompAuthChannelInterceptor), không phải ở tầng HTTP handshake này.
